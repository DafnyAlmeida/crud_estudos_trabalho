        ...
        <div class="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-10">
            ...
            @if (Route::has('login'))
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                           class="inline-flex items-center justify-center gap-2 rounded-xl border border-purple-100 bg-white px-5 py-2 text-sm font-bold text-purple-600 shadow-sm transition hover:border-purple-200 hover:bg-purple-50">
                            Entrar
                        </a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                               class="rounded-xl bg-violet-600 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-violet-100 transition hover:bg-violet-700">
                                Criar conta
                            </a>
                        @endif
                    @endauth
    ...
    <section id="recursos" class="mx-auto max-w-6xl px-5 py-16 lg:px-8">
        ...
        <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-2xl border border-slate-100 bg-white p-5 shadow-lg shadow-slate-100 transition hover:-translate-y-1">
                ...
                <p class="mt-3 text-sm leading-6 text-slate-500">
                    Veja a evolução na sua organização e mantenha a consistência nos estudos.
                </p>
            </div>
