<x-app-layout>
                ...
                <div class="mb-5 flex items-start justify-between gap-5">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-500">
                            Crie um conteúdo para organizar seus estudos e acompanhar seu aprendizado.
                        </p>
                    </div>
                        ...
                        <div class="mt-5 grid grid-cols-1 gap-5 md:grid-cols-[0.8fr_1.2fr]">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    class="mt-2 w-full rounded-xl border-slate-200 px-3 py-2.5 text-sm text-slate-700 shadow-sm focus:border-purple-500 focus:ring-purple-500"
                                >
                                    <option value="basico" @selected($nivelSelecionado === 'basico')>
                                        Básico
                                    </option>

                                    <option value="intermediario" @selected($nivelSelecionado === 'intermediario')>
                                        Intermediário
                                    </option>

                                    <option value="avancado" @selected($nivelSelecionado === 'avancado')>
                                        Avançado
                                    </option>
                                </select>
                    ...
                    <aside class="space-y-5">
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            <p class="mt-4 text-xs leading-5 text-slate-500">
                                Essa é apenas uma prévia. Você poderá editar todos os detalhes depois.
                            </p>
                        </section>
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            <div class="mb-4 flex items-center gap-3">
                                ...
                                <h2 class="text-base font-bold text-purple-600">
                                    Dicas para organizar conteúdos
                                </h2>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Use um título direto e uma descrição resumida.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Isso facilita na hora de revisar e filtrar os conteúdos.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Isso ajuda a planejar melhor seus estudos.
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function atualizarNome() {
            previewNome.textContent = inputNome.value.trim() || 'Orações coordenadas';
        }
