<x-app-layout>
    ...
    <main class="min-h-screen bg-gray-50 px-5 py-5">
        <div class="mx-auto max-w-7xl">
            ...
            <form id="form-resumo" action="{{ route('resumos.store', [$materia->id, $conteudo->id]) }}" method="POST">
                @csrf

                {{-- Se sua tabela resumos tiver a coluna area, isso evita erro de campo obrigatório --}}
                <input type="hidden" name="area" value="{{ old('area', $conteudo->area ?? '') }}">
                ...
                <div class="mb-5 flex items-start justify-between gap-5">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-500">
                            Crie um resumo organizado para revisar os pontos principais do conteúdo.
                        </p>
                    </div>
