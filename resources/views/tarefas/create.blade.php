<x-app-layout>
    @php
        $statusSelecionado = old('status', 'a_fazer');
                ...
                <div class="mb-5 flex items-start justify-between gap-5">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-500">
                            Crie uma tarefa para acompanhar o progresso deste conteúdo.
                        </p>
                    </div>
                            ...
                            <div id="previewContainer" class="mt-5 rounded-2xl border border-purple-100 bg-purple-50 p-4">
                                ...
                                <div class="mt-5 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                                    ...
                                    <p id="previewDescricao" class="mt-2 line-clamp-2 text-sm leading-5 text-slate-500">
                                        A descrição da tarefa aparecerá aqui.
                                    </p>
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Tarefas menores são mais fáceis de concluir.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-bold text-slate-900">
                                            Use uma data de entrega
                                        </h3>

                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Isso ajuda a manter uma rotina de estudos.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Mude para fazendo ou feito conforme avançar.
                                        </p>
                                    </div>
                                </div>
                            </div>
