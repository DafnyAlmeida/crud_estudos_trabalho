<x-app-layout>
    @php
        ...
        $corSelecionada = old('cor_tema', $materia->cor_tema);
        $iconeSelecionado = old('icone_tema', $materia->icone_tema);
        $statusSelecionado = old('status', $materia->status);
    @endphp
                ...
                <div class="mb-5 flex items-start justify-between gap-5">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-500">
                            Atualize os dados da matéria, como nome, descrição, cor, status e ícone.
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-[1.5fr_0.9fr]">
                    ...
                    <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="mt-5">
                            ...
                            >{{ old('descricao', $materia->descricao) }}</textarea>
                    ...
                    <div class="flex min-h-[300px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:shadow-md">
                        ...
                        <div class="flex flex-1 flex-col p-5">
                            <div class="mb-5 flex items-start justify-between">
                                ...
                                <span id="cardStatus"
                                    class="rounded-full px-3 py-1 text-xs font-medium {{ $statusSelecionado === 'arquivada' ? 'bg-slate-100 text-slate-600' : 'bg-green-100 text-green-600' }}">
                                    {{ $statusSelecionado === 'arquivada' ? 'Arquivada' : 'Ativa' }}
                                </span>
                            </div>

                            <h2 id="cardNome" class="text-xl font-semibold text-slate-900">
                                {{ old('nome', $materia->nome) ?: 'Nome da matéria' }}
                            </h2>

                            <p id="cardDescricao" class="mt-2 line-clamp-3 min-h-[50px] text-sm leading-5 text-slate-500">
                                {{ old('descricao', $materia->descricao) ?: 'Descrição da matéria aparecerá aqui.' }}
                            </p>
                            ...
                            <div class="mt-6 border-t border-slate-100 pt-4">
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-2 text-sm text-slate-500">
                                        ...
                                        <span>
                                            {{ $materia->conteudos_count ?? 0 }}
                                            {{ ($materia->conteudos_count ?? 0) == 1 ? 'conteúdo' : 'conteúdos' }}
                                        </span>
                                    </div>

                                    <div class="flex items-center gap-2 text-sm text-slate-500">
                                        <span>
                                            {{ $materia->tarefas_count ?? 0 }}
                                            {{ ($materia->tarefas_count ?? 0) == 1 ? 'tarefa' : 'tarefas' }}
                                        </span>
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Mude apenas as informações que realmente precisam ser ajustadas.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            Use cores diferentes para reconhecer suas matérias rapidamente.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs leading-5 text-slate-500">
                                            O card ao lado mostra como a matéria aparecerá no painel.
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function atualizarNome() {
            const nome = inputNome.value.trim() || 'Nome da matéria';
